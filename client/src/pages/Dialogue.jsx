...
const Dialogue = () => {
    ...
    const dialogueMessage = [
        ...
        " Cette formation à pour but de me perfectionner sur des languages comme le javascript avec ses frameworks React.js et Node.js, l'approfondissement de PHP avec son framework Symfony. Durant cette formation, je vais également apprendre la gestion de projet, les méthodes de travail (agile...), le conception et modélisation",
